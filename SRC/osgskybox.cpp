...
Skybox::Skybox()
{
    ...
    osg::Drawable* drawable = new osg::ShapeDrawable(new osg::Sphere(osg::Vec3(0.0f, 0.0f, 0.0f), 10));
        ...
        const std::string& negz)
{
    ...
    osg::ref_ptr<osg::Image> imagePosX = osgDB::readImageFile(posx);
    osg::ref_ptr<osg::Image> imageNegX = osgDB::readImageFile(negx);
    osg::ref_ptr<osg::Image> imagePosY = osgDB::readImageFile(posy);
    osg::ref_ptr<osg::Image> imageNegY = osgDB::readImageFile(negy);
    osg::ref_ptr<osg::Image> imagePosZ = osgDB::readImageFile(posz);
    osg::ref_ptr<osg::Image> imageNegZ = osgDB::readImageFile(negz);
